...
public class Login {
    ...
    public static boolean login(String username, String password, String path)

    {
        ...
        return Reader.checkPassword(check, path);
    ...
    public static void createUser(String username, String password, String name, int privilege, String path)

    {
        ...
        if(UpdateUser.getList() == null)
        {
            Management.addObject(path + "\\users.ser", user);
        }
        else {
            if (UpdateUser.contains(username)) {
